MODULE constants_NSWC
  ...
  IMPLICIT NONE
  INTEGER, PARAMETER     :: dp = SELECTED_REAL_KIND(18,64)
  ...
  !     Local variable
  REAL (kind=dp) :: r, zero = 0.0_dp, three = 3.0_dp
  ...
  ! Local variables
  REAL (kind=dp) :: d, eps, r, w, x, y, zero = 0.0_dp
  ...
  !-------------------
  REAL (kind=dp) :: aq(3), arg, c, cf, d, eps, p, p1, q, q1, r, ra, rb, rq, rt, &
  ...
  !     Local variables
  COMPLEX (kind=dp) :: w
  REAL (kind=dp)    :: b, b2, c, d, e, h, p, q, r, t, temp(4), u, v, v1, v2,  &
